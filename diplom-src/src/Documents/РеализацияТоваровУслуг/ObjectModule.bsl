...
Процедура ВКМ_ВыполнитьАвтозаполнение() Экспорт 
	...
	РеквизитыДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Договор, 
		...
		|ВКМ_СуммаЕжемесячнойАбоненсткойПлаты");
		
	Если НЕ (РеквизитыДоговора.ВКМ_ДатаНачалаДействияДоговора <= Дата И РеквизитыДоговора.ВКМ_ДатаОкончанияДействияДоговора >= Дата) Тогда 
	...
	Если РеквизитыДоговора.ВКМ_СуммаЕжемесячнойАбоненсткойПлаты <> 0 Тогда 
		
		НоваяСтрока = Услуги.Добавить();
		НоваяСтрока.Номенклатура = НоменклатураАбонентскаяПлата;
		НоваяСтрока.Сумма = РеквизитыДоговора.ВКМ_СуммаЕжемесячнойАбоненсткойПлаты;
		НоваяСтрока.Количество = 1;
		НоваяСтрока.Цена = РеквизитыДоговора.ВКМ_СуммаЕжемесячнойАбоненсткойПлаты;		
